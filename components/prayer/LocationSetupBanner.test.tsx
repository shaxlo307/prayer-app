...
describe("LocationSetupBanner", () => {
  ...
  it("calls onLocationResolved with coords when GPS is granted", async () => {
    ...
    await render(
      <LocationSetupBanner onLocationResolved={onLocationResolved} />,
    );
  ...
  it("submits a manual city/country and calls onLocationResolved", async () => {
    ...
    fireEvent.changeText(screen.getByLabelText("City"), "Tashkent");
    fireEvent.changeText(screen.getByLabelText("Country"), "Uzbekistan");
